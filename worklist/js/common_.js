...
function uiFileCtrl()
{
	$(".file").each(function ()
	{
		if ($.browser.name == "firefox")
		{
			$('label[for="' + $(this).attr("id") +
				'"]').unbind("click.알플러스코리아").bind(
				"click.알플러스코리아", function ()
				{
	...
	$(".file").unbind("change.알플러스코리아").bind(
		"change.알플러스코리아", function ()
		{
			if ($(this).val())
			{
				$('label[for="' + $(this).attr("id") +
